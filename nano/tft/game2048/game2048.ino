...
#define TILE              28
#define TILE_GAP          2
#define BOARD_X           5     // (128 - (4*28 + 3*2)) / 2
#define BOARD_Y           34

#define RESTART_HOLD_MS   1000

// 5-6-5 색을 컴파일 타임에 만들어 PROGMEM 표에 넣는다.
#define RGB565(r, g, b)   ((uint16_t)((((r) & 0xF8) << 8) | (((g) & 0xFC) << 3) | ((b) >> 3)))

#define EMPTY_COLOR       RGB565(58, 58, 52)
#define BOARD_BG          RGB565(30, 30, 28)
...
void drawTile(byte pos) {
  ...
  tft.setTextColor((e <= 2) ? RGB565(70, 60, 50) : COLOR_WHITE);
...
void drawScore() {
  ...
  tft.setTextSize(2);
  tft.setTextColor(RGB565(237, 194, 46));
  tft.setCursor(4, 8);
  tft.print("2048");
...
void showWin() {
  tft.fillRect(0, TFTH2 - 14, TFTW, 28, RGB565(237, 194, 46));
...
void loop() {
  titleScreen("2048", "JOYSTICK = SLIDE", "HOLD BUTTON = RESET", COLOR_YELLOW);
  showHighScore("2048", EEPROM_ADDR);
