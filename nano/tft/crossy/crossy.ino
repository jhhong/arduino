...
// 그래서 차가 24대여도 한 프레임에 칠하는 픽셀은 얼마 안 된다.
...
#define GOAL_ROW          0             // 맨 위 = 도착 지점
#define START_ROW         (ROWS - 1)    // 맨 아래 = 출발 지점
#define LANE_COUNT        (ROWS - 2)    // 가운데 8줄이 찻길
...
#define ROAD_COLOR        tft.Color565(24, 24, 24)
...
void drawPlayer() {
  ...
  tft.fillRect(x + 3, y + 8, BODY - 6, 2, tft.Color565(10, 100, 20));
}
...
void loop() {
  titleScreen("CROSSY", "JOYSTICK = HOP", "REACH THE TOP", COLOR_LIME);
  showHighScore("CROSSY", EEPROM_ADDR);
