...
void printIRsensor1(){
  oled.clear();
  printText(0, "Protocol: NEC");
  printText(1, "Address: 0x0");
  printText(2, "Command : 0x40");
  printText(3, "sendRC5(0x0,0x40,1)");
}

void printIRsensor2(){
  oled.clear();
  printText(0, "ABCDEFGHIJKLMNOPQRSTUV"); //U까지 출력
  printText(1, "abcdefghijklmnopqrstuv"); //v까지 출력
  printText(2, "0123456789012345678901"); //1까지 출력
  printText(3, "!@#$%^&*()-+=;:");
}
